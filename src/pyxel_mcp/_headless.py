...
def patch_game_loop(on_frame, on_show=None, pre_update=None, on_run=None):
    ...
    Args:
        ...
        on_run: Called with (update, draw) when pyxel.run() is invoked,
            before the game loop starts. Use for App instance extraction.
    """
